                        ...
                        <div className="flex items-center">
                            { leftPanel! && leftPanel.custom && (leftPanel.custom) }
                            {
                                leftPanel! && leftPanel.edit && (
                                    <button
                                        onClick={leftPanel.edit.onClick}
                                        disabled={leftPanel.edit.isDisabled}
                                        className="p-2 text-gray-600 bg-gray-100 border border-transparent rounded cursor-pointer hover:bg-gray-200 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray"
                                    >
                            ...
                            {
                                leftPanel! && leftPanel.promotions && (
                                    <button
                                        onClick={leftPanel.promotions.onClick}
                                        disabled={leftPanel.promotions.isDisabled}
                                        className="p-2 mr-2 text-gray-600 bg-gray-100 border border-transparent rounded cursor-pointer hover:bg-gray-200 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray"
                                    >
                                        <IoMdPricetags className="w-5 h-5 icon icon-tabler icon-tabler-bookmark" />
                                    </button>
                                )
                            }
                            {
                                leftPanel! && leftPanel.settings && (
                                    <button
                                        onClick={leftPanel.settings.onClick}
                                        disabled={leftPanel.settings.isDisabled}
                                        className="p-2 mx-2 text-gray-600 bg-gray-100 border border-transparent rounded cursor-pointer hover:bg-gray-200 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray"
                                    >
                            ...
                            {
                                leftPanel! && leftPanel.delete && (
                                    <button
                                        onClick={leftPanel.delete.onClick}
                                        disabled={leftPanel.delete.isDisabled}
                                        className="p-2 text-red-500 bg-gray-100 border border-transparent rounded cursor-pointer hover:bg-gray-200 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray"
                                    >
