                ...
                <div className="space-y-4">
                    <label className="inline-block w-full">
                        <input
                            type="email"
                            placeholder="Email"
                            className={`input w-full border border-gray-400 outline-none ${errors.email && 'border-b-2 border-orange-500'
                                }`}
                    ...
                    <label className="inline-block w-full">
                        <input
                            ...
                            className={`input w-full border border-gray-400 outline-none ${errors.password && 'border-b-2 border-orange-500'
                                }`}
                        />
                        {errors.password && (
                            <p className="p-1 text-[13px] font-light  text-orange-500">
