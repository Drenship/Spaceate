        ...
        <AdminscreenWrapper title="Products">
            ...
            <div className="flex flex-col items-start justify-between w-full p-4 lg:flex-row lg:p-8 lg:items-stretch">
                <div className="flex flex-col items-start w-full lg:w-1/3 lg:flex-row lg:items-center">
                    <div className="flex items-center">
                        <a className="p-2 text-gray-600 bg-gray-100 border border-transparent rounded cursor-pointer dark:bg-gray-700 dark:hover:bg-gray-600 hover:bg-gray-200 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray" href="javascript: void(0)">
                        ...
                        <a className="p-2 mx-2 text-gray-600 bg-gray-100 border border-transparent rounded cursor-pointer dark:bg-gray-700 dark:hover:bg-gray-600 hover:bg-gray-200 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray" href="javascript: void(0)">
                        ...
                        <a className="p-2 mr-2 text-gray-600 bg-gray-100 border border-transparent rounded cursor-pointer dark:bg-gray-700 dark:hover:bg-gray-600 hover:bg-gray-200 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray" href="javascript: void(0)">
                ...
                <div className="flex flex-col items-start justify-end w-full lg:w-2/3 lg:flex-row lg:items-center">
                    <div className="flex items-center py-3 border-gray-300 lg:border-l lg:border-r dark:border-gray-200 lg:py-0 lg:px-6">
                        ...
                        <a className="text-gray-600 border border-transparent rounded cursor-pointer focus:outline-none" onclick="pageView(true)">
                    ...
                    <div className="flex items-center pb-3 border-gray-300 lg:border-r dark:border-gray-200 lg:pb-0 lg:px-6">
                        <div className="relative z-10 w-32">
                            <div className="absolute inset-0 z-0 w-5 h-5 m-auto mr-2 text-gray-600 pointer-events-none xl:mr-4">
