...
const TableProductLine = ({ checkAll } : any) => {
    ...
    return (
        <tr className="h-24 border-b border-gray-300">
            <td className="pl-8 pr-6 text-sm leading-4 tracking-normal text-left text-gray-800 whitespace-no-wrap">
                <input type="checkbox" defaultChecked={checkboxChecked} className="relative w-5 h-5 bg-white border border-gray-400 rounded outline-none cursor-pointer" onclick="tableInteract(this)" />
            </td>
