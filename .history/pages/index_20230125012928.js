...
const Home = () => {
  ...
  return (
    <BasescreenWrapper title="Accueil">
      ...
      <div className='w-full max-w-2xl px-4 mx-auto lg:max-w-7xl'>
        <img className='object-cover w-full h-40' src="/devassets-images/food-background-fruits-vegetables-banner.jpg" />
      </div>
