    ...
    return (
        <div className="z-50 mt-2">
            <div className="flex items-end justify-end">
                ...
                <div role="alert" className="relative flex justify-between h-[88px] py-4 pl-3 pr-4 transition duration-150 ease-in-out rounded shadow sm:items-center bg-gray-800 sm:pr-8 sm:py-0" id="notification">
