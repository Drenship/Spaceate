    ...
    return (
        <div className="fixed z-50 bottom-2 right-2">
            <div className="flex items-end justify-end">
                ...
                <div role="alert" className="relative flex justify-between h-[88px] py-4 transition duration-150 ease-in-out bg-white rounded shadow sm:items-center dark:bg-gray-800" id="notification">
                    ...
                    <div className="right-0 flex items-center justify-center h-full pl-5 border-gray-200 sm:border-l dark:border-gray-700 absolue aspect-square">
                        <button
