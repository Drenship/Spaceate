...
export default function Notification({ title, subTitle }) {
        ...
        <div className="fixed z-50 bottom-2 right-2">
            <div className="flex items-end justify-end">
                ...
                <div role="alert" className="relative flex justify-between py-4 pl-3 pr-4 transition duration-150 ease-in-out bg-white rounded shadow sm:items-center dark:bg-gray-800 sm:pr-8 sm:py-0" id="notification">
                    <img className="absolute bottom-0" src="https://cdn3d.iconscout.com/3d/premium/thumb/cart-5590713-4652405.png" width={50} />
