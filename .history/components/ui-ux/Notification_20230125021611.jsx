...
export default function Notification({ type, title, subTitle }) {
    ...
    return (
        <div className="fixed z-50 bottom-2 right-2">
            <div className="flex items-end justify-end max-h-[88px]">
                {/*code for notification starts*/}
                <div role="alert" className="relative flex justify-between h-full py-4 pl-3 pr-4 transition duration-150 ease-in-out bg-white rounded shadow sm:items-center dark:bg-gray-800 sm:pr-8 sm:py-0" id="notification">

                    <img className="relative h-full aspect-square" src={imageNotificationUrl} />
