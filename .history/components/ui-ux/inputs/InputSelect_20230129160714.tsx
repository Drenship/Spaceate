...
type PropsOption = {
    option: OptionType,
    setUpdate: () => React.Dispatch<React.SetStateAction<OptionType>>
}
...
export default function InputSelect({ input, options }: PropsInput) {
    ...
    const [inputValue, setInputValue] = useState<React.Dispatch<React.SetStateAction<OptionType>>>(defaultValue);
