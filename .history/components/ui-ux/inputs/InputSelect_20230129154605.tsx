...
function Option({ option }: PropsOption) {
    ...
    return (
        <button className='w-full'>
            <p className="w-full p-3 text-sm leading-none text-gray-600 cursor-pointer hover:bg-indigo-100 hover:font-medium hover:text-indigo-700 hover:rounded">
                { option.name }
            </p>
        </button>
    )
...
export default function InputSelect({ options } : PropsInput) {
