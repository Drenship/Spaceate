        ...
        <nav className="fixed top-0 z-50 justify-between h-16 space-x-4 shadow-lg navbar bg-base-100 md:px-8">
            ...
            <div className="flex-none space-x-4">
                ...
                </div>
                {
                    ...
                    ) : <Link href="/auth/login" className='hidden px-4 py-2 text-sm font-bold uppercase border border-black rounded lg:block button-clickèeffect'>Se connecter</Link>
