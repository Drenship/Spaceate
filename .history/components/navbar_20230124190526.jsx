...
function Navbar() {
    ...
    return (
        <nav className="fixed top-0 z-50 justify-between h-16 space-x-4 shadow-lg navbar bg-base-100 md:px-8">
            ...
            <div className='relative overflow-x-hidden border border[#f3f6fd] bg-[#f3f6fd] rounded-full shadow-lg w-full max-w-[480px] h-10 flex justify-between items-center px-3'>
                ...
                <div className='absolute top-0 left-0 right-0 w-full h-20 bg-red-900'>
