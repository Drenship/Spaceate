...
import { CART_REMOVE_ITEM, setCartState } from '@atoms/setStates/setCartState';
        ...
        <nav className="fixed top-0 z-50 justify-between h-16 space-x-4 shadow-lg navbar bg-base-100 md:px-8">
            ...
            <div className="flex-none space-x-4">
                ...
                </div>
                {
                    ...
                    ) : <Link href="/auth/login" className='hidden px-4 py-2 font-semibold uppercase border border-black rounded md:block'>Se connecter</Link>
