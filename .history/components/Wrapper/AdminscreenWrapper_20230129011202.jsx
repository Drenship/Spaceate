...
import { HiTemplate, HiArchive, HiCollection, HiClipboardList, HiGift } from "react-icons/hi";

const NavLinkItem = ({ href, title, children }) => (
    <Link
        href={href}
        className='flex items-center w-full h-12 p-2 pl-6 space-x-2 font-bold uppercase bg-white border-b hover:bg-gray-100/50 hover:shadow-lg'
    >
        { children }
        <span>{title}</span>
    </Link>
